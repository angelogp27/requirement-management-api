...
('88888888-8888-8888-8888-888888888806', '44444444-4444-4444-4444-444444444441', 'RNF-ECO-001', 'RNF_RENDIMIENTO', 'El tiempo de carga de la pagina principal debe ser menor a 2 segundos bajo carga normal.', 'Experiencia de usuario.', 'Sprint 1', '- Pruebas con Lighthouse score > 90.', '22222222-2222-2222-2222-222222222221', 'APROBADO', 'ALTA', '33333333-3333-3333-3333-333333333331', NULL, NULL),
('88888888-8888-8888-8888-888888888807', '44444444-4444-4444-4444-444444444441', 'RNF-ECO-002', 'RNF_RENDIMIENTO', 'El sistema debe soportar 5000 usuarios concurrentes sin degradacion severa.', 'Escalabilidad.', 'Sprint 4', '- Pruebas en JMeter sin errores 500.', '22222222-2222-2222-2222-222222222221', 'REGISTRADO', 'CRITICA', NULL, NULL, NULL),
('88888888-8888-8888-8888-888888888808', '44444444-4444-4444-4444-444444444441', 'RNF-ECO-003', 'RNF_DISENO', 'Toda comunicacion debe realizarse a traves de TLS 1.3 o superior.', 'Seguridad.', 'Sprint 1', '- Escaneo de puertos y certificados SSL A+.', '22222222-2222-2222-2222-222222222221', 'APROBADO', 'CRITICA', '33333333-3333-3333-3333-333333333332', NULL, NULL),
...
('88888888-8888-8888-8888-888888888818', '44444444-4444-4444-4444-444444444444', 'RNF-AI-001', 'RNF_CALIDAD', 'El modelo debe tener un nivel de alucinacion (respuestas incorrectas) menor al 5%.', 'Calidad de IA.', 'Sprint 1', '- Evaluacion manual de 100 respuestas.', '22222222-2222-2222-2222-222222222221', 'EN_ANALISIS', 'CRITICA', NULL, NULL, NULL),
('88888888-8888-8888-8888-888888888819', '44444444-4444-4444-4444-444444444444', 'RNF-AI-002', 'RNF_RENDIMIENTO', 'El bot debe responder en un maximo de 3 segundos.', 'Experiencia de usuario fluida.', 'Sprint 1', '- Latencia medida desde request a response.', '22222222-2222-2222-2222-222222222221', 'APROBADO', 'ALTA', '33333333-3333-3333-3333-333333333331', NULL, NULL),
